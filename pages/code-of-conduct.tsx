const CodeOfConduct = () => (
	<div className="container mx-auto">
		<h1 className="text-3xl" id="elsa-health-code-of-conduct">
			Elsa Health Code of Conduct
		</h1>
		<h2 className="text-xl mt-5" id="our-pledge">
			Our Pledge
		</h2>
		<p>
		...
		<h2 className="text-xl mt-5" id="our-standards">
			Our Standards
		</h2>
		<p>
		...
		<h2 className="text-xl mt-5" id="enforcement-responsibilities">
		...
		<h2 className="text-xl mt-5" id="scope">
			Scope
		</h2>
		<p>
		...
		<h2 className="text-xl mt-5" id="enforcement">
			Enforcement
		</h2>
		<p>
			Instances of abusive, harassing, or otherwise unacceptable behavior
			may be reported to the community leaders responsible for enforcement
			at info@inspiredideas.io or directly to the Inspired Ideas head of
			Open Source kevin@inspiredideas.io. All complaints will be reviewed
		...
		<h2 className="text-xl mt-5" id="enforcement-guidelines">
		...
		<h2 className="text-xl mt-5" id="attribution">
			Attribution
		</h2>
		<p>
